...
class EditDeparture extends Component {
  ...
  async componentDidMount() {
    ...
    if (this.props.location.pathname === "/editDep") {
      this.setState(
        {
          ...
          departureFlag: true,
          depDateSearch: JSON.parse(sessionStorage.getItem("depFlight"))
            .DepartureDate,
          // minDate : (JSON.parse(sessionStorage.getItem('depFlight'))).DepartureDate,
          minDate: new Date().toISOString().substring(0, 10),
          maxDate: JSON.parse(sessionStorage.getItem("retFlight"))
            .DepartureDate,
        },
        () =>
          console.log(
      ...
      this.setState({
        ...
        depDateSearch: JSON.parse(sessionStorage.getItem("retFlight"))
          .DepartureDate,
  ...
  andSearch() {
    ...
    if (this.state.departureFlag) {
      this.setState({
        searchResults: this.state.flightsArr.filter(
          (f) =>
  ...
  async handleFinalChange() {
    ...
    console.log(
      "reservation isssssssssssssssssssssssssssssssssss",
      reservation
    );
